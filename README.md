...
Se añadio el segundo nivel, el primero se mantuvo igual, con el enemigo haciendo wander, seek y flee.
El segundo en cambio es un laberinto con 2 nuevos enemigos con IAs diferentes:
